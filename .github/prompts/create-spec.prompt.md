...
2. ユーザの指示（目的/背景）を元に、テンプレートに従って仕様を構造化する
...
- **Plan**: eliteがタスク分解する際の観点
- **タスクリスト**: mobへ配布する単位（task / assignee / input / output）

注意：
- ACは具体的・検証可能に
- 仕様が曖昧な場合はユーザに質問して確定させる
- 作成後は `status/dashboard.md` への記録をeliteに依頼する
