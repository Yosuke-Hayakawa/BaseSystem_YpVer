...
- **Plan**: Coordinatorがタスク分解する際の観点
- **タスクリスト**: Workerへ配布する単位（task / assignee / input / output）

注意：
- ACは具体的・検証可能に
- 仕様が曖昧な場合はユーザー（チームオーナー）に質問して確定させる
- 作成後は `status/dashboard.md` への記録をCoordinatorに依頼する
