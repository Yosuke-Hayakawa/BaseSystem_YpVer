...
- チームメンバーが**根拠のない数値**を出していないか常に目を光らせる
- 報告書に `TODO: 要確認` が残っている場合は、ユーザに出す前にクリアにさせるか、残存TODOとしてユーザに明示する
- mobの成果物→elite検証→最終チェックの流れで、根拠なし数値を3重に弾く体制を維持する
